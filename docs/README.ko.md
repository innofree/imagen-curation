...
**플랫폼별 가이드를 docs에서 확인하세요:**
- **[Ubuntu (Linux)](./install-ubuntu.md)** — Docker pull/build 또는 네이티브
- **[Windows](./install-windows.md)** — WSL2 + Docker Desktop 또는 WSL2 네이티브
...
- 기동 시 마운트 프리플라이트 경고 + `/api/health` healthcheck 내장.
