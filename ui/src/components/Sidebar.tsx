...
import { LayoutDashboard, ListChecks, PlusCircle, Settings, HelpCircle } from "lucide-react";
  ...
  return (
    <aside className="w-56 shrink-0 border-r border-edge bg-panel h-screen sticky top-0 flex flex-col">
      <div className="px-4 py-4 border-b border-edge">
        <div className="font-semibold">🖼️ Curation Lab</div>
        <div className="text-xs text-neutral-500">LoRA dataset curator</div>
      </div>
